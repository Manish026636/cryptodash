    ...
    <section class="flex flex-col items-center">
      ...
      <div class="flex max-w-xl flex-col items-center pb-0 pt-8 text-center sm:pb-16 lg:pb-32 lg:pt-32">
        ...
        <div class="flex w-full flex-col gap-2.5 sm:flex-row sm:justify-center">
          ...
          <button class="inline-block rounded-lg border bg-white px-8 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-100 focus-visible:ring active:bg-gray-200 md:text-base">View Pricing</button>
        </div>
      </div>
    </section>
  </div>
